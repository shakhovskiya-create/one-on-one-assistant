...
1) Прочитай полностью: `ai_org/state/INDEX.md`
2) Прочитай/учти источники истины, на которые он ссылается (минимум: `CONTEXT.md`, `ARCHITECTURE.md`, `WORKPLAN.md`, `DECISIONS.md`, `DOMAIN_GLOSSARY.md`, `STATE_MACHINES.md`, `AI_SAFE_CHECKLIST.md`).
3) Работай как “AI Product Manager”: ты управляешь ролями через файлы в `ai_org/agents/*` и поручения (handoff).
4) Любая значимая работа должна оставлять след:
...
5) Если данных не хватает — НЕ выдумывай. Оформи “вопрос/риск” и запроси недостающее у пользователя.
