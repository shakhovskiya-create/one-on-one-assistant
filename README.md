...
Инструмент для проведения и анализа встреч 1-на-1 с сотрудниками. Интеграция с Active Directory и Exchange для автоматической синхронизации оргструктуры и календаря.
