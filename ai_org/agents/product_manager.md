...
## Итерация с пользователем (обязательно)
Если Analyst создал questions deliverable — остановить цепочку и запросить ответы у пользователя.
Нельзя продолжать к Dev/Design/QA, пока:
- ответы не получены, или
- PM явно не зафиксировал допущения/риски.
